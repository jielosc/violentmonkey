...
const uaVer = navUA.match(new RegExp(
  `\\s(?:${__.SAFARI ? 'Version' : 'Chrom(?:e|ium)|Firefox'})\\/(\\d+[.0-9]*)|$`,
  'i',
))[1];
...
export const CHROME = !IS_FIREFOX && !__.SAFARI ? parseFloat(uaVer) || 1 : undefined;
/** @type {number|void} */
export const SAFARI = __.SAFARI ? parseFloat(uaVer) || 1 : undefined;
...
initDependency(
  Promise.all([
    ...
    ua.arch = arch;
    ua.os = os;
    setBrowserName(name || (__.SAFARI ? 'Safari' : 'chrome'));
